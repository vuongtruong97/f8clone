  ...
  return (
    <div ref={sliderRef} className={clsx(Styles.slider)}>
      ...
      <div style={{ width: clientWidth }} className={clsx(Styles.sliderView)}>
        <div
          ref={sliderListRef}
          style={{ width: clientWidth * SliderData.length }}
          className={clsx(Styles.sliderItemList)}
        >
          {SliderData.map((item, i) => (
            ...
            >
              <div className={clsx(Styles.sliderItem_left)}>
                ...
                <h4 className={clsx(Styles.sliderLeft_desc)}>
                  {item.description}
                </h4>
                <Button className={clsx(Styles.sliderLeft_btn)}>
                  {item.cta_title}
                </Button>
              </div>
